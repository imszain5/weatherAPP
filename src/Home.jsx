                ...
                <div className="row">
                  ...
                  <div className=" row">
                    <div className="col-md-6 pt-5 pt-lg-0 order-1 order-lg-1 d-flex justify-content-center flex-column">
                        <h1> Grow your Buisness with <strong className="navbar-brand">Us.</strong></h1>
                        <h2 className=" my-3">
                            We are the Team of Talented Developers
                        </h2>
                        <div className=" mt-3">
                              <NavLink to="/service" className=" btn btn-danger"> Get Started</NavLink>
                        </div>
                        <div className=" col-lg-6 order-1 order-lg-2 header-img img1">
                              <img style={{background:'#000000'}} src="logo192.png" alt="logo"/>
                        </div>
                    </div>
                </div>
